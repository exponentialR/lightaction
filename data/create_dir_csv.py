...
def create_dir(actions, data_dir):
    ...
    i = 1
    # w = '_'
    if not os.path.exists((data_dir + ('_csv'))):
        data_dir = os.path.join((data_dir + ('_csv')))


    while os.path.exists(data_dir):
        data_dir = ('{}_{}%s'.format(args.pat, 'csv_') % i)
        i += 1
    ...
    for action in actions:
        ...
        try:
            ...
            iams_dict = {'actions': args.actions,
